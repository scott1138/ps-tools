...
Describe 'New-AADServicePrincipal Tests' -Tag 'WindowsOnly','PS5Only' {
    ...
    Context 'No Errors' {
        ...
        Mock New-AADServicePrincipal {$true} -ModuleName PS-Tools
        ...
        It 'Generates the desired output when using certificate auth.' {
